...
namespace Cap.Web.App_Start
{
    public class IocConfig
    {
        public static void ConfigurarDependencias()
        {
            ...
            kernel.Bind<IBaseService<ArquivoMorto>>().To<ArquivoMortoService>();
            ...
            kernel.Bind<IBaseService<ReqAutorizante>>().To<ReqAutorizanteService>();
            ...
            kernel.Bind<IInfoCaixa>().To<InfoCaixaService>();
            ...
            kernel.Bind<IReqComprar>().To<ReqComprarService>();
