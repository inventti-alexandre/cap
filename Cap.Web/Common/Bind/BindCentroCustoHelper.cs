...
namespace Cap.Web.Common.Bind
{
    ...
    {
        public static MvcHtmlString SelectCentroCusto(this HtmlHelper html, int idGrupoCusto, int idCentroCusto = 0, bool selecione = false, string idTag = "IdCentroCusto")
        {
