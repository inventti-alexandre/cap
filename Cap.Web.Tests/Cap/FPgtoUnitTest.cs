...
namespace Cap.Web.Tests.Cap
{
    ...
    public class FPgtoUnitTest
    {
        ...
        {
            // Arrange
            var fpgto01 = new FPgto { AlteradoPor = 2, IdEmpresa = 1, Ativo = true, Descricao = "BANCO" };
            var fpgto02 = new FPgto { AlteradoPor = 2, IdEmpresa = 1, Ativo = true, Descricao = "CHEQUE" };
            var fpgto03 = new FPgto { AlteradoPor = 2, IdEmpresa = 1, Ativo = true, Descricao = "DEPOSITO" };
            var fpgto04 = new FPgto { AlteradoPor = 2, IdEmpresa = 1, Ativo = true, Descricao = "DINHEIRO" };
            var fpgto05 = new FPgto { AlteradoPor = 2, IdEmpresa = 1, Ativo = true, Descricao = "RETENCAO" };
